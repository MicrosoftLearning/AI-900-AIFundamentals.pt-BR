...
Neste laboratório, usaremos o serviço de Detecção facial no Azure para identificar itens do mundo real com base em imagens.

-  Abra o notebook **04 - Face Analysis.ipynb** no Visual Studio Code.
