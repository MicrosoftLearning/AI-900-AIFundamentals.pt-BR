...
Neste laboratório, usaremos o serviço de Visão Personalizada no Azure para identificar um item do mundo real em uma imagem.

-  Abra o notebook **02 - Image Classification.ipynb** no Visual Studio Code.
