...
1. Clique no botão **&#65291;Criar um recurso** e pesquise *Serviços Cognitivos*. Selecione **Criar** um plano dos **Serviços Cognitivos**. Você será levado para uma página para criar um recurso dos serviços de IA do Azure. Defina-o com as seguintes configurações:
